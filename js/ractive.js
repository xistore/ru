...
( function( global ) {
    ...
    var resolveRef = function( normaliseRef, getInnerContext, createComponentBinding ) {
        ...
        ancestorErrorMessage = 'Could not resolve reference - too many "default.htm" prefixes';
        getOptions = {
        ...
        function resolveAncestorReference( baseContext, ref ) {
            ...
            // not an ancestor reference - must be a restricted reference (prepended with "." or "default.htm")
            if ( !baseContext ) {
                return ref.replace( /^\.\/?/, '' );
            }
    ...
    var reference = function( types, patterns ) {
        ...
        return function( parser ) {
            ...
            if ( parser.matchString( '~/' ) ) {
                ...
                ancestor = '';
                while ( parser.matchString( 'default.htm' ) ) {
                    ancestor += 'default.htm';
                }
            }
            if ( !ancestor ) {
                // we might have an implicit iterator or a restricted reference
                dot = parser.matchString( 'default.htm' ) || parser.matchString( '.' ) || '';
            }
